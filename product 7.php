				...
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/11.png">
									<div class="thumb-image">
										<img src="images/11.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="images/11.1.png">
									<div class="thumb-image">
										<img src="images/11.1.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="images/11.2.png">
									<div class="thumb-image">
										<img src="images/11.2.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
							</ul>
							<div class="clearfix"></div>
						</div>

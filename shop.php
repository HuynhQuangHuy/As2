...
<div id="background">
  <div id="page">
      <div id="header"> <span id="connect"> <a href="#" class="facebook"></a> <a href="#" class="twitter"></a> <a href="#" class="vimeo"></a> </span> <span id="infos"> <a href="InsertCustomer.php">Register</a>|<a href="Login.php">Login</a> </span> <a href="index.php" id="logo"></a>
      <!-- /#logo -->
      <ul id="navigation">
    ...
    <div id="footer">
      <div id="description">
        <div> <a href="index.php" class="logo"></a> <span>ATN &copy; 2020 <a href="#">ATN company</a> All rights reserved | Toys <a target="_blank" href="http://www.freewebsitetemplates.com/"></a></span> </div>
